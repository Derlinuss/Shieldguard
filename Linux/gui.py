...
class ShieldGuardGUI:
    def __init__(self):
        ...
        style.configure("Critical.TLabel", foreground="red", font=("Sans", 10, "bold"))
        style.configure("High.TLabel", foreground="#cc3300", font=("Sans", 10))
        style.configure("Clean.TLabel", foreground="green", font=("Sans", 10))
    ...
    def _build_layout(self):
        ...
        for i, (key, color) in enumerate([("scanned", "green"), ("infected", "red"), ("whitelisted", "#cc9900"), ("errors", "#cc6600")]):
            ...
            ttk.Label(f, text=key.title(), font=("Sans", 9)).pack()
            lbl = ttk.Label(f, text="0", foreground=color, font=("Sans", 14, "bold"))
            lbl.pack()
    ...
    def _build_scan_tab(self):
        ...
        self.scan_detail = scrolledtext.ScrolledText(tab, height=6, state="disabled", font=("Monospace", 9))
    ...
    def _build_quarantine_tab(self):
        ...
        self.quar_detail = scrolledtext.ScrolledText(tab, height=6, state="disabled", font=("Monospace", 9))
    ...
    def _build_realtime_tab(self):
        ...
        self.rt_status = ttk.Label(info, text="INACTIVE", foreground="red", font=("Sans", 14, "bold"))
        self.rt_status.pack()
        ...
        self.rt_log = scrolledtext.ScrolledText(tab, height=15, state="disabled", font=("Monospace", 9))
    ...
    def _build_lookup_tab(self):
        ...
        self.lookup_result = scrolledtext.ScrolledText(tab, height=18, state="disabled", font=("Monospace", 9))
    ...
    def _build_log_tab(self):
        ...
        self.log_text = scrolledtext.ScrolledText(tab, state="disabled", font=("Monospace", 9))
    ...
    def _show_lookup_result(self, result):
        ...
        if result.get("detected"):
            ...
            self.lookup_result.tag_config("threat", foreground="red", font=("Monospace", 10, "bold"))
        else:
            self.lookup_result.insert("end", "\u2713  File appears clean\n", "clean")
            self.lookup_result.tag_config("clean", foreground="green", font=("Monospace", 10, "bold"))
    ...
    def _view_reports(self):
        ...
        def show_report():
            ...
            tw.title(name)
            tw.geometry("700x500")
            t = scrolledtext.ScrolledText(tw, font=("Monospace", 9))
